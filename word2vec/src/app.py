...
from .similarity_service import determine_similar_items_with_cosine_distances
...
def run():
    ...
    article_distances = determine_similar_items_with_cosine_distances(mean_vector_of_article)
    print(article_distances)
